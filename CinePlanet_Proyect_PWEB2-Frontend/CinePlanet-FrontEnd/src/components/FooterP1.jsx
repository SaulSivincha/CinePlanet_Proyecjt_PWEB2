          ...
          <div className="col-md-4 mb-4">
            <div className="section-content">
              ...
              <ul className="list-unstyled">
                ...
                <li><a href="https://cdnpe.cineplanet.com.pe/assets/c959094b-0d6b-40d9-9aea-45ea51159257" target="_blank" rel="noopener noreferrer" className="text-light text-decoration-none">Memoria de Gestión 2024</a></li>
              </ul>
            </div>
