  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row g-3">
        ...
        {/* Fila 3: Botón de "Ver más películas" */}
        <div className="col-md-2">
          <div className="bg-danger text-white rounded d-flex align-items-center justify-content-center" style={{ height: '100%' }}>
